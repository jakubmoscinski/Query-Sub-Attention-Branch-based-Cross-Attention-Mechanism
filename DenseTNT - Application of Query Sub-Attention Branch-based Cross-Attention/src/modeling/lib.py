...
class CrossAttention(GlobalGraph):
    ...
    def forward(self, hidden_states_query, hidden_states_key=None, attention_mask=None, mapping=None,
        ...
        mixed_query_layer = self.forward_for_query(hidden_states_query, hidden_states_key)
    ...
    def forward_for_query(self, hidden_states_query, hidden_states_key=None, iterations=1):
            ...
            for _ in range(iterations):
                ...
                output = mixed_query_layer.squeeze(dim=1) * context_layer
                mixed_query_layer = output.view(mixed_query_layer.size())
